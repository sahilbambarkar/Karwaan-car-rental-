...
export const exploreWorlds = [
    {
        ...
        title: "Secure, Dependable, and Elegant ",
        description:
            "At Karwaan, we understand your desires – a seasoned chauffeur behind the wheel, complemented by a flawlessly stylish ride.",
    },
    {
        id: "world-2",
        ...
        description:
            "From Unmatched Luxury to Spacious Comfort: Karwaan Awaits Your Selection!",
    },
    {
        id: "world-3",
        ...
        description:
            "On your wedding day, Karwaan delivers the ultimate luxury ride for an unforgettable journey.",
    },
];
...
export const homeCards = [
    {
        ...
        title: "Our Vision",
        description:
            "Real-time vehicle tracking is revolutionizing transportation by enhancing efficiency and lowering downtimes.",
    },
    {
        img: "/car-6.jpg",
        title: "Our Mission",
...
export const serviceList = [
    {
        id: 1,
        text: "Our Melbourne Air terminal swaps provide top-level unchanging quality and extravagance. Whether you're traveling alone or with family, we provide a pleasant meet-and-greet service, gear assistance, and ongoing traffic and aircraft tracking for consistent appearances. Sit back, relax, and show up refreshed, day or night.",
    ...
    {
        id: 3,
        text: "Karwaan escort excels in corporate, executive, and celebrity transportation, ensuring a serene and seamless journey on every ride. Whether you're meeting a valued client or attending a pivotal business appointment, our service ensures you arrive in a state of relaxation and rejuvenation, allowing you to concentrate on what truly matters. We take pride in delivering smooth, expert, and dependable experiences, without fail.",
